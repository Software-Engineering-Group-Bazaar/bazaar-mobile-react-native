      ...
      <ScrollView style={styles.container} ref={scrollViewRef}>
        ...
        <View style={styles.detailsSection}>
              ...
              {product.wholesaleThreshold != null && (
                <View style={styles.detailRow}>
                  ...
                  <TextInput
                    ...
                    keyboardType="numeric"
                    onChangeText={(text) =>
                      setWholesaleThreshold(parseFloat(text))
                    }
                  />
                </View>
              )}
          ...
          <CopilotStep
            name="availability"
            order={3}
            text={t("help_availability_togle")}
          >
            <WalkthroughableView>
              {/* Availability */}
              <View style={styles.detailRow}>
          ...
          <CopilotStep
            name="saveButton"
            order={4}
            text={t("help_save_product_details")}
          >
            <WalkthroughableView>
              {/* Save Changes Button */}
              <SubmitButton

import {
  ...
  export default function OrderDetailsScreen() {
    ...
    const fetchOrder = async () => {
      ...
      setLoading(true);
      try {
        const res = await api.get(`/order/${id}/details`);
        setOrder(res.data);
      } catch (err) {
      ...
      <View style={styles.rootWrapper}>
        ...
        >
          <View style={styles.section}>
            ...
            <Text style={styles.orderTime}>{new Date(order.orderDate).toLocaleString()} ({getTimeAgo(order.orderDate, t)})</Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            {order.items.map((item: any) => (
              <View key={item.id} style={styles.productItem}>
                ...
                <Text style={styles.productPrice}>{item.pricePerProduct} KM</Text>
              </View>
            ))}
